...
static pok_bool_t mpu_regions_overlap(uint32_t base1, uint32_t size1,
  ...
  /* Check for overflow beyond 32-bit address space
   * Allow regions that end exactly at 4GB boundary (0x100000000) */
