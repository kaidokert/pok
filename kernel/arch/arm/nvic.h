...
/* Priority levels - use values from cortex_m_config.h for consistency */
#define NVIC_PRIORITY_HIGHEST CORTEX_M_PRIORITY_HIGHEST
#define NVIC_PRIORITY_HIGH CORTEX_M_PRIORITY_HIGH
#define NVIC_PRIORITY_NORMAL CORTEX_M_PRIORITY_NORMAL
#define NVIC_PRIORITY_LOW CORTEX_M_PRIORITY_LOW
#define NVIC_PRIORITY_LOWEST CORTEX_M_PRIORITY_LOWEST
...
/* Maximum external interrupt number - derived from vector count
...
/* Default handler for unhandled interrupts (implemented in startup.S) */
