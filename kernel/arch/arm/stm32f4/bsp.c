...
#ifdef POK_NEEDS_DEBUG
    printf(
        "ERROR: Kernel memory exhausted. Requested: %u, Available: %u\n", size,
...
pok_ret_t pok_stm32f4_clock_init(void) {
  volatile uint32_t *RCC_CR =
      (volatile uint32_t *)0x40023800; /* RCC Clock Control Register */
  volatile uint32_t *RCC_PLLCFGR =
      (volatile uint32_t *)0x40023804; /* RCC PLL Configuration Register */
  volatile uint32_t *RCC_CFGR =
      (volatile uint32_t *)0x40023808; /* RCC Clock Configuration Register */
  volatile uint32_t *FLASH_ACR =
      (volatile uint32_t *)0x40023C00; /* Flash Access Control Register */
