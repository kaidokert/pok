...
#error "PLL_N must be between 192 and 432"
#endif
...
#endif
#if VCO_OUT_FREQ < 192000000 || VCO_OUT_FREQ > 432000000
#error "VCO output frequency must be between 192-432 MHz"
#endif
...
/* Compile-time validation of clock frequencies to prevent overclocking */
#if AHB_PRESCALER == 0
#error "AHB_PRESCALER must be non-zero to avoid divide-by-zero"
#endif
#if APB1_PRESCALER == 0
#error "APB1_PRESCALER must be non-zero to avoid divide-by-zero"
#endif
#if APB2_PRESCALER == 0
#error "APB2_PRESCALER must be non-zero to avoid divide-by-zero"
#endif
#if SYSCLK_FREQ_HZ > 168000000
#error "SYSCLK frequency exceeds 168MHz maximum for STM32F4"
#endif
#if AHB_FREQ_HZ > 168000000
#error "AHB frequency exceeds 168MHz maximum for STM32F4"
#endif
#if APB1_FREQ_HZ > 42000000
#error "APB1 frequency exceeds 42MHz maximum for STM32F4"
#endif
#if APB2_FREQ_HZ > 84000000
#error "APB2 frequency exceeds 84MHz maximum for STM32F4"
#endif
