...
// Ocarina compatibility aliases (Ocarina generates POK_PORT_* prefix)
#define POK_PORT_QUEUEING_DISCIPLINE_FIFO POK_QUEUEING_DISCIPLINE_FIFO
#define POK_PORT_QUEUEING_DISCIPLINE_PRIORITY POK_QUEUEING_DISCIPLINE_PRIORITY
